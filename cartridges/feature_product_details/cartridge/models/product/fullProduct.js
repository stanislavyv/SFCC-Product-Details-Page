...
module.exports = function fullProduct(product, apiProduct, options) {
    ...
    decorators.quantitySelector(
        product,
        apiProduct.stepQuantity.value,
        options.variables,
        options.options
    );
    ...
    if (
        !category &&
        (options.productType === "variant" ||
            options.productType === "variationGroup")
    ) {
